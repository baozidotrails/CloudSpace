...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { img: @space.img, is_rented: @space.is_rented, name: @space.name, user_id: @space.user_id }
    end
  ...
  test "should update space" do
    patch :update, id: @space, space: { img: @space.img, is_rented: @space.is_rented, name: @space.name, user_id: @space.user_id }
    assert_redirected_to space_path(assigns(:space))
  end
